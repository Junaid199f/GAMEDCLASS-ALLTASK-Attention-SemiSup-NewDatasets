...
def read_dataset(file_path,task_name,task_type,pop_size,max_pop_size,epochs):
  ...
  data = {'x_train': x_train, 'y_train': y_train,'x_val':x_val,'y_val':y_val, 'x_test': x_test, 'y_test': y_test}
  a = AutoCNN(pop_size, max_pop_size,task_type,data,task_name, epoch_number=16)
  a.run()
...
if __name__ == '__main__':
  ...
  read_dataset('data/dermamnist.npz','dermamnist','multi-label binary-class',20,30,15)
  ...
  #read_dataset('data/organamnist.npz','organamnist','multi-label binary-class',18,19,10)
